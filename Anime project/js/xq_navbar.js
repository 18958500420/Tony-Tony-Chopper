;(function( $ , win , undefined){
	$.fn.xq_navbar = function( _option ){
		...
		this.line=function(){
			var move=$("<div/>",{"class":"xq_move"}).css({ "height":"4px","left":"-100px","width":"100px"}).appendTo(_self);
			switch(defaults.type){
				...
				case "line":
					move.css({"top":"0px"});
					$("<div/>",{"class":"xq_move"}).css({ "bottom":"0px","height":"4px","left":"-100px","width":"100px"}).appendTo(_self);
					break;
			}
			var width;
